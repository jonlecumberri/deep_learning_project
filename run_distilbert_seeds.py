...
FINAL_RESULTS_DIR = os.path.join(BASE_DIR, "DeepLearning/project/deep_learning_project/results/results_distilbert_seeds")
MODEL_BASE_DIR = os.path.join(BASE_DIR, "DeepLearning/project/deep_learning_project/models/models_distilbert_seeds")
...
for seed in SEEDS:
    ...
    ]).to_csv(os.path.join(RESULTS_DIR, "distilbert_eval_metrics.csv"), index=False)

    pd.DataFrame({
        "step": train_metrics["step"],
        "train_acc": train_metrics["accuracy"],
        "train_loss": train_metrics["loss"]
    }).to_csv(os.path.join(RESULTS_DIR, "distilbert_train_progress.csv"), index=False)
